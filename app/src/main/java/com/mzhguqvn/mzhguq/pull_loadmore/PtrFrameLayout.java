...
import com.mzhguqvn.mzhguq.pull_loadmore.loadmore.DefaultLoadMoreFooter;
import com.mzhguqvn.mzhguq.pull_loadmore.loadmore.GridViewHandler;
import com.mzhguqvn.mzhguq.pull_loadmore.loadmore.ILoadViewMoreFactory;
import com.mzhguqvn.mzhguq.pull_loadmore.loadmore.ILoadViewMoreFactory.ILoadMoreView;
import com.mzhguqvn.mzhguq.pull_loadmore.loadmore.ListViewHandler;
import com.mzhguqvn.mzhguq.pull_loadmore.loadmore.OnLoadMoreListener;
import com.mzhguqvn.mzhguq.pull_loadmore.loadmore.OnScrollBottomListener;
import com.mzhguqvn.mzhguq.pull_loadmore.loadmore.RecyclerViewHandler;
import com.mzhguqvn.mzhguq.util.LogUtil;
...
public class PtrFrameLayout extends ViewGroup {
    ...
    public PtrFrameLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray arr = context.obtainStyledAttributes(attrs, com.mzhguqvn.mzhguq.R.styleable.PtrFrameLayout, 0, 0);
        if (arr != null) {

            mHeaderId = arr.getResourceId(com.mzhguqvn.mzhguq.R.styleable.PtrFrameLayout_ptr_header, mHeaderId);
            mContainerId = arr.getResourceId(com.mzhguqvn.mzhguq.R.styleable.PtrFrameLayout_ptr_content, mContainerId);

            mPtrIndicator.setResistance(
                    arr.getFloat(com.mzhguqvn.mzhguq.R.styleable.PtrFrameLayout_ptr_resistance, mPtrIndicator.getResistance()));

            mDurationToClose = arr.getInt(com.mzhguqvn.mzhguq.R.styleable.PtrFrameLayout_ptr_duration_to_close, mDurationToClose);
            mDurationToCloseHeader = arr.getInt(com.mzhguqvn.mzhguq.R.styleable.PtrFrameLayout_ptr_duration_to_close_header, mDurationToCloseHeader);

            float ratio = mPtrIndicator.getRatioOfHeaderToHeightRefresh();
            ratio = arr.getFloat(com.mzhguqvn.mzhguq.R.styleable.PtrFrameLayout_ptr_ratio_of_header_height_to_refresh, ratio);
            mPtrIndicator.setRatioOfHeaderHeightToRefresh(ratio);

            mKeepHeaderWhenRefresh = arr.getBoolean(com.mzhguqvn.mzhguq.R.styleable.PtrFrameLayout_ptr_keep_header_when_refresh, mKeepHeaderWhenRefresh);

            mPullToRefresh = arr.getBoolean(com.mzhguqvn.mzhguq.R.styleable.PtrFrameLayout_ptr_pull_to_fresh, mPullToRefresh);
            arr.recycle();
        }
